...
VALUES
  ...
  ('pth_VRX8SFUP', 'path', 'ROOT_README_TEMPLATE_PATH', 'text', 'storage/templates/root-readme.md', 'canonical repo-relative path for the root README template file'),
  ('pth_NBXRX8DJ', 'path', 'DOCS_00_SCOPE_TEMPLATE_PATH', 'text', 'storage/templates/docs_00_scope.md', 'canonical repo-relative path for the docs/00_scope template file'),
  ('pth_NDHYAK0V', 'path', 'DOCS_01_CONTEXT_TEMPLATE_PATH', 'text', 'storage/templates/docs_01_context.md', 'canonical repo-relative path for the docs/01_context template file'),
  ('pth_0BKL6KQO', 'path', 'DOCS_02_WORKFLOW_TEMPLATE_PATH', 'text', 'storage/templates/docs_02_workflow.md', 'canonical repo-relative path for the docs/02_workflow template file'),
  ('pth_2ZBODJI4', 'path', 'DOCS_03_ACCEPTANCE_TEMPLATE_PATH', 'text', 'storage/templates/docs_03_acceptance.md', 'canonical repo-relative path for the docs/03_acceptance template file'),
  ('pth_TER9ZB10', 'path', 'DOCS_04_TASK_TEMPLATE_PATH', 'text', 'storage/templates/docs_04_task.md', 'canonical repo-relative path for the docs/04_task template file'),
  ('pth_WJ1T7U2G', 'path', 'DOCS_05_DECISION_TEMPLATE_PATH', 'text', 'storage/templates/docs_05_decision.md', 'canonical repo-relative path for the docs/05_decision template file'),
  ('pth_XPZRIEUC', 'path', 'DOCS_06_MEMORY_TEMPLATE_PATH', 'text', 'storage/templates/docs_06_memory.md', 'canonical repo-relative path for the docs/06_memory template file when that optional file is used'),
  ('pth_PTVAK9DZ', 'path', 'CODEX_TASK_PROMPT_TEMPLATE_PATH', 'text', 'storage/templates/codex_task_prompt.md', 'canonical repo-relative path for the Codex task prompt template file'),
